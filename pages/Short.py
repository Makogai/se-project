...
class url_shortner:
    ...
    def create(self):
        if self.url.get() == "":
            ...
            self.output = Entry(self.root, font=(
                'verdana', 10, 'bold'), fg="purple", width=30, relief=GROOVE, borderwidth=2, border=2)
    ...
    def __init__(self):
        ...
        self.title = Label(self.root, text="URL Shortner", font=(
            'verdana', 15, 'bold'), bg="white", fg="purple")
        ...
        Label(self.root, text="Paste Your Url Here ..", font=(
            'verdana', 10, 'bold'), fg="purple").place(x=50, y=50)

        self.url = Entry(self.root, width=50, bg="lightgrey",
                         relief=GROOVE, borderwidth=2, border=2)
        self.url.place(x=50, y=80)

        self.button = Button(self.root, relief=GROOVE, text="Create", font=(
            'verdana', 8, 'bold'), bg="purple", fg="white", command=self.create)
